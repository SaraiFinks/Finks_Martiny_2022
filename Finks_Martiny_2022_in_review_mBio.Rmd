...
filtered.plsdb <-
  read_excel(
    "~/Google Drive/My Drive/uci_grad_school/my_projects/ch2/plasmids__2020_06_29__v0.4.1-6-g8ad6422194/filtered_plsdb.xlsx"
  )
filtered.plsdb  <-
  as.data.frame(filtered.plsdb, col.names	=	TRUE,	row.names	=	TRUE)
filtered.plsdb[1:10 , 1:10]
...
```{r Quantifying plasmids counts by species: E. coli and K. pneumoniae, echo=FALSE}
...
mob_ecoli <-
  read_excel(
    "~/Google Drive/My Drive/uci_grad_school/my_projects/ch2/plasmids__2020_06_29__v0.4.1-6-g8ad6422194/trait_analysis/all_mob.xlsx",
    sheet = "ecoli"
  )
